...
const shareGroup = async(req, res) => {
    try {
        ...
        if(!groupData) {
            ...
            res.render('error',  {message: 'you need to login to access the group'});
        } else {
            ...
            res.render('shareLink', {group: groupData, available: available, totalMembers: totalMembers, isJoined: isJoined, isOwner: isOwner});
        }
...
const joinGroup = async(req, res) => {
    try {
        ...
        res.send( {success: true, msg: 'Congratulations, you have joined the group Successfully'});
